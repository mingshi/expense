...
(function(){
    ...
    $('#popup-msg').delegate('.close', 'click', function(event){
    ...
    function popup_msg(msg, type)
    {
        ...
        $('#popup-msg').html(msg).show();
        $('#popup-msg').attr('class', 'alert alert-' + type);
        var left = ($(window).width() - ($('#popup-msg').attr('offsetWidth') || $('#popup-msg').prop('offsetWidth'))) / 2;
        $('#popup-msg').css('left', left);//.hide().slideDown();
        startTime = + new Date;
        clearHideTimer();
